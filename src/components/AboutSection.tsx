...
import { MapPin, Clock, Shield, Wifi, Car, Coffee, Zap, Droplets } from 'lucide-react';
...
const AboutSection: React.FC = () => {
  ...
  const defaultFeatures = [
    ...
    },
    {
      icon: Coffee,
      title: 'Dapur Bersama',
      description: 'Fasilitas dapur bersama lengkap dengan peralatan memasak dan area makan yang nyaman'
    },
    {
      icon: Zap,
      title: 'Listrik Stabil',
      description: 'Supply listrik stabil dengan backup generator untuk memastikan kenyamanan penghuni'
    },
    {
      icon: Droplets,
      title: 'Air Bersih',
      description: 'Sumber air bersih dari pegunungan Lembang yang jernih dan segar sepanjang hari'
    },
    {
      icon: Clock,
      title: 'Akses Fleksibel',
      description: 'Akses masuk 24 jam dengan sistem kunci elektronik untuk kenyamanan penghuni'
    }
  ];
  ...
  const features = config?.aboutFeatures?.map(feature => ({
  ...
  const aboutDescription = config?.aboutDescription || 'Kost Pak Jajang Lembang telah melayani penghuni selama lebih dari 10 tahun dengan komitmen memberikan hunian yang nyaman, aman, dan terjangkau di kawasan wisata Lembang yang sejuk.';
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Untuk menjaga kenyamanan bersama, berikut adalah beberapa peraturan 
                yang perlu dipatuhi oleh seluruh penghuni kost.
              </p>
